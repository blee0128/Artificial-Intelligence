...
class Checkers_Game:
    ...
    # def utility(self, state, player):
    #     """Original utility function. Return the value of this final state to player."""
    #     return state.utility if player == 1 else -state.utility

    # evaluation function 1
    # def utility(self, state, player):
    #     """Return the value of this final state to player. This is the first evaluation function. It gives a higher score to
    #     pieces that are king"""
    #     board = state.board
    #     o_sum = 0
    #     x_sum = 0
    ...
    # def utility(self, state, player):
    #     """Return the value of this final state to player. It takes the total number for each player
